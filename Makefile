...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/code1.0.0/ && $(COPY_FILE) --parents mainwindow.h music.h .tmp/code1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp music.cpp .tmp/code1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/code1.0.0/ && (cd `dirname .tmp/code1.0.0` && $(TAR) code1.0.0.tar code1.0.0 && $(COMPRESS) code1.0.0.tar) && $(MOVE) `dirname .tmp/code1.0.0`/code1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/code1.0.0
